...
import ProfilePicture from "../../assets/img/profile-picture-3.jpg";
...
export default (props = {}) => {
  ...
  const NavItem = (props) => {
    ...
    const navItemClassName = pathname.search(link)!=-1? "active" : "";
            ...
            <div className="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
              <div className="d-flex align-items-center">
                ...
                <div className="d-block">
                  <h6>Hi, Jane</h6>
                  <Button as={Link} variant="secondary" size="xs" to={'/login'} className="text-dark">
                    <FontAwesomeIcon icon={faSignOutAlt} className="me-2" /> Sign In
                  </Button>
                </div>
              </div>
