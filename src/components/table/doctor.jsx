...
export const DoctorListTable = (props)=>{
    ...
    const TableRow = (props) => {
      const { department,department_id,idd,email,description,name,status,r } = props;
      let id=idd;
      return (
        <tr>
          ...
          <Button variant="primary" onClick={()=>doAction("admin/doctor/"+id,0,{department,department_id,id,email,description,name,status,id})} size="sm" className="m-1">Edit</Button>
          <Button variant="danger" onClick={()=>doAction("admin/doctor/"+id,3,{department,id,description,name,status,id})} size="sm" className="m-1">Delete</Button>
          </td>
        </tr>
      );
    };
