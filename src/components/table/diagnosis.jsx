...
export const DiagnosistListTable = (props)=>{
    const {linker}=props;
    ...
    const TableRow = (props) => {
      const {diagnosis,problem,status,firstname,lastname,uuid,email,middlename,phone,address,bloodgroup,sex,dob,id,r } = props;
      ...
      return (
        <tr>
          ...
          <td className="border-0">
            {/* <ValueChange value={overallRankChange} /> */}
            {diagnosis?JSON.parse(diagnosis).join():"-"}
          </td>
          <td className="border-0">
            {/* <ValueChange value={overallRankChange} /> */}
            {problem?JSON.parse(problem).join():"-"}
          </td>
          <td className="border-0">
            {/* <ValueChange value={overallRankChange} /> */}
          ...
          <Button variant="primary" onClick={()=>doAction("admin/diagnosis/"+id,1,{firstname,lastname,uuid,email,middlename,phone,address,bloodgroup,sex,dob,status,id})} size="sm" className="m-1">Edit</Button>
          <Button variant="danger" onClick={()=>doAction("admin/diagnosis/"+id,3,{firstname,lastname,uuid,email,middlename,phone,address,bloodgroup,sex,dob,status,id})} size="sm" className="m-1">Delete</Button>
          </td>
        </tr>
      );
    };
