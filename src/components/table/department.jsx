...
export const DepartmentListTable = (props)=>{
    const {linker}=props;
   const gARch=(id)=>{
     props.doArchive(id);
   }
    ...
    const TableRow = (props) => {
      const { department,id,description,r } = props;
      ...
      return (
        <tr>
          ...
          <Button variant="danger" onClick={()=>gARch("/admin/fields/department/delete/"+id)} size="sm" className="m-1">Delete</Button>
          </td>
        </tr>
      );
    };
