...
import { AppointmenttListTable } from "../../components/table/appointment";
import { BASE_URL } from '../../.env.js';

export default function DashboardAppointment({navigation, route}) {
...
const [getDiagnosisd, setDiagnosisd] = useState({});
    ...
    const getDashData=async()=>{
      ...
      try {
        ...
        const resp=await axios.get(BASE_URL+'admin/appointment',{
            headers: {
    ...
    const retrieveSearch= async(e)=>{
        ...
        let token =await  _retrieveToken();
        try{
        const resp=await axios.get(BASE_URL+'admin/appointment/search?idno='+e,{
            headers: {
               Authorization: "Bearer "+token
            }
        })
